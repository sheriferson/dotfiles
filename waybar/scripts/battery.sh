...
time_to_empty=$(upower -i /org/freedesktop/UPower/devices/battery_BATT | awk -F: '/time to empty/ {print $2}' | xargs)
time_to_full=$(upower -i /org/freedesktop/UPower/devices/battery_BATT | awk -F: '/time to full/ {print $2}' | xargs)
